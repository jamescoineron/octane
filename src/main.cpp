...
#if defined(NDEBUG)
# error "Octane cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Octane Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees, int nHeight)
{
    ...
    {
	nSubsidy = 0 * COIN; // No POW reward after block 11,520
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees, int nHeight)
{
    ...
    // LUCKY POWER UPS
    if(nHeight >= 888 && nHeight % 888 == 0)
    {
	nSubsidy = 8 * COIN;
    }
    else if(nHeight >= 8888 && nHeight % 8888 == 0)
    {
	nSubsidy = 88 * COIN;
    }
    else if(nHeight >= 88888 && nHeight % 88888 == 0)
    {
	nSubsidy = 8888 * COIN;
    }
