...
void static BitcoinMiner(CWallet *pwallet)
{
	...
	CBlock *pblock = pblocktemplate.get();
        ...
        LogPrintf("Running OctaneMiner with %llu transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("OctaneMiner terminated\n");
        throw;
    }
}
